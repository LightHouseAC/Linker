package com.aus.linker.user.biz.domain.dataobject;
...
public class UserDO implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getLinkerId() == null ? other.getLinkerId() == null : this.getLinkerId().equals(other.getLinkerId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLinkerId() == null) ? 0 : getLinkerId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", linkerId=").append(linkerId);
